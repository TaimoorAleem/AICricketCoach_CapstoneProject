...
abstract class DeliveryRepository {
  ...
  Future<DataState<List<DeliveryEntity>>> getDeliveriesForSession(String sessionId);

  /// Retrieves a specific delivery by its ID.
  /// Returns a `DataState` with the `Delivery` object (success) or an error (failure).
  Future<DataState<DeliveryEntity>> getDeliveryById(String sessionId, String deliveryId);
  ...
  Future<DataState<String>> createDelivery(String sessionId, DeliveryEntity delivery);
  ...
  Future<DataState<bool>> updateDelivery(String sessionId, DeliveryEntity delivery);
