...
class BallLength:
    ...
    def determine_pitch_length(self):
        pitch_zones = {
            ...
            "short pitched": [(54, 210), (192, 200), (54, 300), (192, 300)],
...
if __name__ == "__main__":
    ...
    print(f"Ball Speed: {avg_speed:.2f} km/h")
    batsman_position_json = 2 # if its 2 something went wrong

    ball_speed_json = round(avg_speed, 2)
    if batsman_hand == "right":
        batsman_position_json = 0
    elif batsman_hand == "left":
        batsman_position_json = 1
    ball_line_json = pitch_line
    ball_length_json = pitch_length


    characteristics = {
        'BallSpeed' : ball_speed_json,
        'BatsmanPosition' : batsman_position_json,
        'BallLine': ball_line_json,
        'BallLength': ball_length_json}
